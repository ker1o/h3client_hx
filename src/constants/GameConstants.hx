...
class GameConstants {
    public static var PUZZLE_MAP_PIECES:Int = 48;

    public static var MAX_HEROES_PER_PLAYER:Int = 8;
    public static var AVAILABLE_HEROES_PER_PLAYER:Int = 2;

    public static var ALL_PLAYERS:Int = 255; //bitfield

    public static var BACKPACK_START:Int = 19;
    public static var CREATURES_PER_TOWN:Int = 7; //without upgrades
    public static var SPELL_LEVELS:Int = 5;
    public static var SPELL_SCHOOL_LEVELS:Int = 4;
    public static var CRE_LEVELS:Int = 10; // number of creature experience levels

    public static var HERO_GOLD_COST:Int = 2500;
    public static var SPELLBOOK_GOLD_COST:Int = 500;
