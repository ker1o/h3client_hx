...
//    var size:Point;
    ...
    function drawToPos(drawer:IDrawer, posX:Int, posY:Int, src:Rect, alpha:Int = 255):Void;
    function drawToRect(drawer:IDrawer, dest:Rect, src:Rect, alpha:Int = 255):Void;
